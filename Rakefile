...
namespace :optimizeimages do
  ...
  task :run do
    ...
    file_list = FileList.new 'source/images/**/*.{gif,jpeg,jpg,png}'

    last_optimized_path = 'source/images/.last_optimized'
...
task :sitemapgoogle do
  begin
    ...
    Net::HTTP.get('www.google.com', '/webmasters/tools/ping?sitemap=' + URI.escape('http://www.backthatelfup.com/sitemap.xml'))
  rescue LoadError
...
task :sitemapbing do
  begin
    ...
    Net::HTTP.get('www.bing.com', '/webmaster/ping.aspx?siteMap=' + URI.escape('http://www.backthatelfup.com/sitemap.xml'))
  rescue LoadError
